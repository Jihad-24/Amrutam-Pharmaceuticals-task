...
const Harmony = () => {
  return (
    ...
    <div className="min-h-[500px] max-h-[500px] relative">
      ...
      <div className="absolute flex items-center justify-center min-h-[500px] max-h-[500px] w-full left-0 top-0 bg-gradient-to-t from-[#18181880] text-center to-[#22222257] text-white max-w-[1350px]">
        <div className="text-center py-10">
